...
public class Utils {
    ...
    protected static List<String> fetchEarthquakeData(String requestUrl){
    ...
    private static List<String> extractFeatureFromJson(String earthquakeJSON){
        ...
        try{
            ...
            for(int i=0; i < earthquakeArray.length(); i++){
                ...
                String longitude = coordinate.getString(0);
                String latitude = coordinate.getString(1);
                String mag = properties.getString("mag");
                quakeList.add(title + "@" + time + "@" + url + "@" + latitude + "@" + longitude + "@" + mag);
            }
            return quakeList;
